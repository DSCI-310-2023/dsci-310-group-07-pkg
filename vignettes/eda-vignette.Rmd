...
```{r plotAll, message=FALSE, warning=FALSE, fig.width=6,fig.height=5}
...
```{r plotAll-cont, message=FALSE, warning=FALSE,fig.width=6,fig.height=5}
plots[[2]]
```

```{r plotAll-more, message=FALSE, warning=FALSE,fig.width=6,fig.height=5}
plots[[3]]
```
